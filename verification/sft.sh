...
export WANDB_PROJECT_NAME="llm_multi_node_verification"
export WANDB_RUN_NAME="multi_node_qwen235B"


# CHECKPOINT_DIR="$HOME/training/multinode/sft/checkpoints_${SLURM_JOB_ID}"


CHECKPOINT_DIR="/home/Competition2025/P12/P12U025/model_checkpoint/checkpoints_${SLURM_JOB_ID}"
